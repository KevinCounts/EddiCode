...
def parsefile(infile):
    ...
    outfile = "EDDI_attribution_avg_" +TSnum+TStype+'_'+str(date)+".png"
    return outfile, MM, DD, YYYY,TStype,TSnum,TSout
...
def plotgen(path,dir_list,time):
    ...
    outfile, MM, DD, YYYY,TStype,TSnum,TSout = parsefile(infile)
    fig.suptitle(TSnum + '-' +TSout + ' Average contribution to the ETrs anomaly (mm) ' +YYYY+'.'+MM+'.'+DD, ha='center') 
