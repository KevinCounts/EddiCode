...
def parsefile(infile):
    ...
    outfile = "EDDI_attribution_" +str(date)+".png"
    return outfile, MM, DD, YYYY
...
def plotgen(path,dir_list):
    ...
    outfile, MM, DD, YYYY = parsefile(infile)
    fig.suptitle('Daily contribution to the ETrs anomaly (mm) ' +YYYY+'.'+MM+'.'+DD+'\n', ha='center') 
